...
build_time_vars = {
    ...
    'AR': '/Users/codebuilder/Library/Android/sdk/ndk/27.3.13750724/toolchains/llvm/prebuilt/darwin-x86_64/bin/llvm-ar',
    'ARFLAGS': 'rcs',
    ...
    'BLDSHARED': '/Users/codebuilder/Library/Android/sdk/ndk/27.3.13750724/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android21-clang -shared -Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/lib',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '.exe',
    ...
    'BYTESTR_DEPS': '\\',
    'CC': '/Users/codebuilder/Library/Android/sdk/ndk/27.3.13750724/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android21-clang',
    'CCSHARED': '-fPIC',
    'CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -D__BIONIC_NO_PAGE_SIZE_MACRO -I/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/include',
    ...
    'CONFIGURE_CFLAGS': '-D__BIONIC_NO_PAGE_SIZE_MACRO -I/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/include',
    ...
    'CONFIGURE_CPPFLAGS': '',
    'CONFIGURE_LDFLAGS': '-Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/lib',
    'CONFIGURE_LDFLAGS_NODIST': '',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'--host=aarch64-linux-android' '--build=aarch64-apple-darwin25.0.0' '--with-build-python=/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/build/python.exe' '--without-ensurepip' '--enable-shared' '--without-static-libpython' '--with-openssl=/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix' 'build_alias=aarch64-apple-darwin25.0.0' 'host_alias=aarch64-linux-android' 'PKG_CONFIG=pkg-config --define-prefix' 'PKG_CONFIG_LIBDIR=/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/lib/pkgconfig' 'CC=/Users/codebuilder/Library/Android/sdk/ndk/27.3.13750724/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android21-clang' 'CFLAGS=-D__BIONIC_NO_PAGE_SIZE_MACRO -I/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/include' 'LDFLAGS=-Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/lib'",
    'CONFINCLUDEDIR': '/usr/local/include',
    'CONFINCLUDEPY': '/usr/local/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/lcov-report',
    ...
    'CXX': '/Users/codebuilder/Library/Android/sdk/ndk/27.3.13750724/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android21-clang++',
    ...
    'FILEMODE': 644,
    'FREEZE_MODULE': '/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/build/python.exe ../../Programs/_freeze_module.py',
    'FREEZE_MODULE_BOOTSTRAP': '/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/build/python.exe ../../Programs/_freeze_module.py',
    ...
    'LDFLAGS': '-Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/lib',
    'LDFLAGS_NODIST': '',
    ...
    'LIBEXPAT_CFLAGS': '-I../../Modules/expat -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -D__BIONIC_NO_PAGE_SIZE_MACRO -I/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/include -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include -fPIC -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    'LIBHACL_CFLAGS': '-I../../Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -D__BIONIC_NO_PAGE_SIZE_MACRO -I/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/include -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include -fPIC -fPIC',
    'LIBHACL_HEADERS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-I../../Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -D__BIONIC_NO_PAGE_SIZE_MACRO -I/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/include -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include -fPIC -fPIC',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    ...
    'LIBS': '-ldl  -llog',
    'LIBSUBDIRS': 'asyncio \\',
    'LINKCC': '/Users/codebuilder/Library/Android/sdk/ndk/27.3.13750724/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android21-clang',
    ...
    'MODULE__CTYPES_CFLAGS': '-fno-strict-overflow -I/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/include',
    'MODULE__CTYPES_DEPS': '../../Modules/_ctypes/ctypes.h',
    'MODULE__CTYPES_LDFLAGS': '-L/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/lib -lffi -ldl',
    ...
    'MODULE__HASHLIB_CFLAGS': '-I/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/include',
    'MODULE__HASHLIB_DEPS': '../../Modules/hashlib.h',
    'MODULE__HASHLIB_LDFLAGS': '-L/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/lib   -lcrypto',
    ...
    'MODULE__LZMA_CFLAGS': '-I/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/include',
    'MODULE__LZMA_LDFLAGS': '-L/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/lib -llzma',
    ...
    'MODULE__SQLITE3_CFLAGS': '-I/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/include -I../../Modules/_sqlite',
    ...
    'MODULE__SQLITE3_LDFLAGS': '-L/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/lib -lsqlite3',
    'MODULE__SQLITE3_STATE': 'yes',
    'MODULE__SRE_LDFLAGS': '',
    'MODULE__SSL_CFLAGS': '-I/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/include',
    ...
    'MODULE__SSL_LDFLAGS': '-L/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/lib  -lssl -lcrypto',
    ...
    'PYTHONPATH': '',
    'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__android_aarch64-linux-android _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/`cat pybuilddir.txt`) /Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/build/python.exe',
    'PYTHON_FOR_BUILD_DEPS': '',
    'PYTHON_FOR_FREEZE': '/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/build/python.exe',
    'PYTHON_FOR_REGEN': '',
    'PYTHON_HEADERS': '\\',
    'PYTHON_OBJS': '\\',
    'PY_BUILTIN_HASHLIB_HASHES': '"md5,sha1,sha2,sha3,blake2"',
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -D__BIONIC_NO_PAGE_SIZE_MACRO -I/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/include -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include -fPIC -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -D__BIONIC_NO_PAGE_SIZE_MACRO -I/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/include',
    ...
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -D__BIONIC_NO_PAGE_SIZE_MACRO -I/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/include -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include -fPIC -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/lib',
    'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../../Include',
    'PY_ENABLE_SHARED': 1,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '-Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/lib',
    'PY_LDFLAGS_NODIST': '',
    'PY_LDFLAGS_NOLTO': '-Wl,--build-id=sha1 -Wl,--no-rosegment -Wl,-z,max-page-size=16384 -Wl,--no-undefined -lm -L/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/lib',
    'PY_SQLITE_ENABLE_LOAD_EXTENSION': 0,
    'PY_SQLITE_HAVE_SERIALIZE': 1,
    'PY_SSL_DEFAULT_CIPHERS': 1,
    'PY_SSL_DEFAULT_CIPHER_STRING': 0,
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -D__BIONIC_NO_PAGE_SIZE_MACRO -I/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/prefix/include -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../../Include/internal -I../../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../../Include -fPIC',
    'PY_SUPPORT_TIER': 3,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 1,
    'Py_GIL_DISABLED': 0,
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': '_PYTHON_PROJECT_BASE=/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__android_aarch64-linux-android _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/`cat pybuilddir.txt`) /Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/build/python.exe',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': '_PYTHON_PROJECT_BASE=/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__android_aarch64-linux-android _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/`cat pybuilddir.txt`) /Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/build/python.exe -m test',
    ...
    'abs_builddir': '/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android',
    'abs_srcdir': '/Volumes/CodeSSD/GitHub/swift_gradle_example/Python-3.13.8/cross-build/aarch64-linux-android/../..',
